<template>
    <div class="login">
        ...
        <div class="form">
            ...
            <div class="other">
                <router-link class="register" to="/login">返回登陆</router-link>
            </div>
        </div>
    </div>
</template>
        ...
        async submit() {
            if (this.zhanghao.length != 11) {
                ...
                if (this.code.length != 4) {
                    ...
                    if (this.password2.length == 0 || this.password1.length == 0) {
                        this.error = "请输入密码";
                        this.$message({
                            message: this.error,
                            center: true,
                        ...
                        if (this.password2.length < 6 || this.password1.length < 6) {
                            this.error = "密码格式不正确，不少于6位";
                            this.$message({
                                message: this.error,
                                center: true,
                            });
